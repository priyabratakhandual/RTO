...
@app.route('/v1/api/new_inquiry', methods=['POST'])
def api_new_inquiry():
...
@app.route('/v1/api/followup/<student_id>', methods=['GET'])
...
@app.route('/v1/api/dashboard', methods=['GET'])
def api_dashboard():
...
@app.route('/v1/api/students', methods=['GET'])
def api_students():
